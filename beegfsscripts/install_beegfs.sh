...
install_beegfs_repo()
{
    ...
    wget -O beegfs-rhel6.repo https://www.beegfs.io/release/beegfs_7-rc/dists/beegfs-rhel6.repo
        #wget-O beegfs-rhel7.repo http://www.beegfs.com/release/beegfs_6/dists/beegfs-rhel6.repo
	

    mv beegfs-rhel6.repo /etc/yum.repos.d/beegfs.repo
    sed -i 's/beegfs_7/beegfs_7-rc/g' /etc/yum.repos.d/beegfs.repo
    #rpm --import http://www.beegfs.com/release/beegfs_2015.03/gpg/RPM-GPG-KEY-beegfs
    rpm --import https://www.beegfs.io/release/beegfs_7-rc/gpg/RPM-GPG-KEY-beegfs
